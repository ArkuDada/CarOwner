...
if (mysqli_num_rows($result) > 0){
    ...
    while ($row = mysqli_fetch_array($result)) {
        $ID=$row['ID'];
        echo "<tr><td>". $row['Grade'] . "</td><td>" . $row['STName'] . "</td><td>" . $row['STSurName']."</td></tr><tr><td>" .
            $row['Grade2'] . "</td><td>" . $row['STN2'] . "</td><td>" . $row['STSN2']."</td></tr><tr><td>" . $row['Grade3'] . "</td><td>" . $row['STN3'] . "</td><td>" . $row['STSN3']."</td></tr>";
        echo "<br>";
    }
    echo "</table>";
}
